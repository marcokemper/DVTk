...
namespace Dvtk.Sessions
{
        ...
        , IDicomDir
	{
        ...
        public void WriteHtml(System.String htmlText, bool writeToSummary, bool writeToDetail)
        {
            if (htmlText == null)
            {
            ...
            this.m_topSerializer.SerializeHtmlUserReport(Wrappers.WrappedValidationMessageLevel.Information, htmlText, writeToSummary, writeToDetail);
        }

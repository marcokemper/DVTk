...
DVT_STATUS VALUE_UC_CLASS::Set(string value)
...
DVT_STATUS VALUE_UC_CLASS::Set (unsigned char *value, UINT32 size)
...
DVT_STATUS VALUE_UC_CLASS::Get (unsigned char **value, UINT32 &size)
...
DVT_STATUS VALUE_UC_CLASS::Get(string &value, bool)
...
//<<===========================================================================
{
    ...
    DVT_STATUS result1 = EXTCHARACTERSET->IsValidExtendedChar(valueM, sizeM, ATTR_VR_UC, UC_LENGTH, messages, specific_character_set);
...
DVT_STATUS VALUE_UC_CLASS::Compare(LOG_MESSAGE_CLASS*, BASE_VALUE_CLASS *ref_value)
...
//<<===========================================================================
{
    ...
    if (ref_value->GetVRType() != ATTR_VR_UC)
    {
...
ATTR_VR_ENUM VALUE_UC_CLASS::GetVRType(void)
...
UINT32 VALUE_UC_CLASS::GetLength (void)

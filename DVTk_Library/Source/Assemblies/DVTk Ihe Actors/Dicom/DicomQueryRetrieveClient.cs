...
namespace Dvtk.IheActors.Dicom
{
	...
	/// </summary>
	public class DicomQueryRetrieveClient : DicomClient
	{
		/// <summary>
		/// Class constructor.
		/// </summary>
		...
		public DicomQueryRetrieveClient(BaseActor parentActor, ActorName actorName) 
            : base(parentActor, actorName, false)
		{
			_presentationContexts = new PresentationContext[1];

			PresentationContext presentationContext = new PresentationContext("1.2.840.10008.5.1.4.1.2.1.1", // Abstract Syntax Name

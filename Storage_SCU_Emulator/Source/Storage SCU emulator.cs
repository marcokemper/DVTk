...
namespace StorageSCUEmulator
{
	...
	public class StorageSCUEmulator : System.Windows.Forms.Form
	{
        ...
        {
            storageOptions.SaveToFile(Path.Combine(applDirectory, "StorageSCUEmulator.ses"));
            storageCommitSCUOptions.SaveToFile(Path.Combine(applDirectory, "CommitSCUEmulator.ses"));
        }

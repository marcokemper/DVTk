...
DVT_STATUS VALUE_UT_CLASS::Set(string value)
...
DVT_STATUS VALUE_UT_CLASS::Set (unsigned char *value, UINT32 size)
...
DVT_STATUS VALUE_UT_CLASS::Get (unsigned char **value, UINT32 &size)
...
DVT_STATUS VALUE_UT_CLASS::Get(string &value, bool)
...
bool VALUE_UT_CLASS::operator = (BASE_VALUE_CLASS &value)
...
DVT_STATUS VALUE_UT_CLASS::Check (UINT32,
                                  BASE_VALUE_CLASS **,
...
//<<===========================================================================
{
    ...
    DVT_STATUS result1 = EXTCHARACTERSET->IsValidExtendedChar(valueM, sizeM, ATTR_VR_UT, UT_LENGTH, messages, specific_character_set);
...
DVT_STATUS VALUE_UT_CLASS::Compare(LOG_MESSAGE_CLASS*, BASE_VALUE_CLASS *ref_value)
...
//<<===========================================================================
{
    ...
    if (ref_value->GetVRType() != ATTR_VR_UT)
    {
...
ATTR_VR_ENUM VALUE_UT_CLASS::GetVRType(void)
...
UINT32 VALUE_UT_CLASS::GetLength (void)

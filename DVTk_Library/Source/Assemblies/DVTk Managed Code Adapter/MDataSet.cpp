...
namespace Wrappers
{
	...
	DvtkData::Dimse::DataSet __gc* MDataSet::ReadFile(System::String __gc* pFileName, bool unVrDefinitionLookUp)
	{
	...
	DvtkData::Media::FileMetaInformation __gc* MDataSet::ReadFMI(System::String __gc* pFileName, bool unVrDefinitionLookUp)
	{
		char* pAnsiStringFileName = (char*)(void*)Marshal::StringToHGlobalAnsi(pFileName);

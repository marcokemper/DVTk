    ...
    class DvtkSummaryResults
    {
        ...
        public void FromXml(String filename)
        {
            try
            {
                ...
                {
                    reader.ReadStartElement("DvtSummaryResultsFile");
            ...
            {
                // do nothing here - we always end with an exception when reading the DVTK core summary results due to a final CR LF in the file.
            }
        }

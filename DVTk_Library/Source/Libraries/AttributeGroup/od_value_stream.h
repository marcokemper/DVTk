...
#ifndef OD_VALUE_STREAM_H
#define OD_VALUE_STREAM_H
...
class OD_VALUE_STREAM_CLASS : public OTHER_VALUE_STREAM_CLASS
...
public:
    ...
    DVT_STATUS Compare(LOG_MESSAGE_CLASS*, OD_VALUE_STREAM_CLASS&);
};


#endif /* OD_VALUE_STREAM_H */

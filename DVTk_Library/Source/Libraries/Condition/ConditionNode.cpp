...
DCM_ATTRIBUTE_CLASS *CONDITION_NAVIGATION_HERE_NODE_CLASS::Navigate(DCM_ATTRIBUTE_GROUP_CLASS* obj1_ptr, DCM_ATTRIBUTE_GROUP_CLASS* obj2_ptr, LOG_CLASS* logger_ptr)
...
//<<===========================================================================
{
	...
	// navigate node
    DCM_ATTRIBUTE_CLASS *attribute_ptr = GetNavigationNode()->Navigate(obj1_ptr, obj2_ptr, logger_ptr);
	if (attribute_ptr)
	{
		AddMessage("T");
	}
...
DCM_ATTRIBUTE_CLASS *CONDITION_NAVIGATION_UP_NODE_CLASS::Navigate(DCM_ATTRIBUTE_GROUP_CLASS* obj1_ptr, DCM_ATTRIBUTE_GROUP_CLASS*, LOG_CLASS* logger_ptr)
	...
	if (sqValue_ptr != NULL)
	{
		...
		if (attributeSq_ptr != NULL)
		{
			...
			if (obj1_ptr != NULL)
			{
				...
				attribute_ptr = GetNavigationNode()->Navigate(obj1_ptr, NULL, logger_ptr);
			}
		}
	}
...
DCM_ATTRIBUTE_CLASS *CONDITION_NAVIGATION_DOWN_NODE_CLASS::Navigate(DCM_ATTRIBUTE_GROUP_CLASS* obj1_ptr, DCM_ATTRIBUTE_GROUP_CLASS*, LOG_CLASS* logger_ptr)
...
//<<===========================================================================
{
		...
		(attributeSq_ptr->GetVR() == ATTR_VR_SQ))
	{
			...
			(sqValue_ptr->GetNrItems() > 0))
		{
			...
			attribute_ptr = GetNavigationNode()->Navigate(item_ptr, NULL, logger_ptr);
		}
	}
...
//<<===========================================================================
{
	...
	// check whether the attribute is present in the object
	DCM_ATTRIBUTE_CLASS* attribute_ptr = obj1_ptr->GetMappedAttribute(tag_groupM, tag_elementM);

	if (attribute_ptr == NULL && obj2_ptr != NULL)
	{
		// check whether the attribute is present in the co-object
		attribute_ptr = obj2_ptr->GetMappedAttribute(tag_groupM, tag_elementM);
	}

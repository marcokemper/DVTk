...
// TODO : Missing rules VAL_RULE_D_OBOW!!!
    void ValidationMessageInfo::_StaticConstructor()
    {
        ...
        System::Object __gc* conditionText           = __box(WrappedValidationMessageLevel::ConditionText);
        ...
        pLevelTable->Add(__box(::VAL_RULE_D_VR_2            ), information);
        pLevelTable->Add(__box(::VAL_RULE_D_VR_3            ), error);
        //
		...
		//
        pLevelTable->Add(__box(::VAL_RULE_D_ODDLEN_1        ), error);
        //
        ...
        pLevelTable->Add(__box(::VAL_RULE_D_PRESENCE_5      ), conditionText);
        //
        ...
        pLevelTable->Add(__box(::VAL_RULE_D_PRESENCE_12     ), conditionText);
        pLevelTable->Add(__box(::VAL_RULE_D_PRESENCE_13     ), error);
        pLevelTable->Add(__box(::VAL_RULE_D_PRESENCE_14     ), information);
		//
		...
		//
        pLevelTable->Add(__box(::VAL_RULE_PRIVATE_1         ), error);
        pLevelTable->Add(__box(::VAL_RULE_PRIVATE_2         ), error);
        //
		...
		pLevelTable->Add(__box(::VAL_RULE_DEF_COMMAND_3     ), error);
        ...
        pLevelTable->Add(__box(::VAL_RULE_DEF_DEFINITION_7  ), information);
		//
        ...
        pLevelTable->Add(__box(::VAL_RULE_R_VR_2            ), warning);
       //
        // Rules regarding value multiplicity
        //

...
namespace DvtkHighLevelInterface.Common.Other
{
    ...
    class GenericBooleanExpressionOr<T, TCollection> : GenericBooleanExpression<T, TCollection>
        where TCollection : IList, new()
    {
        ...
        /// </summary>
        private GenericBooleanExpressionOr()
        {
        ...
        public GenericBooleanExpressionOr(GenericBooleanExpression<T, TCollection> booleanExpression1, GenericBooleanExpression<T, TCollection> booleanExpression2)
        {
    ...
    class GenericBooleanExpressionOr<T1, TCollection1, T2, TCollection2> : GenericBooleanExpression<T1, TCollection1, T2, TCollection2>
        where T1 : class
        ...
        where TCollection2 : IList, new()
    {
        ...
        /// <param name="booleanExpression1">The first boolean expression on which the logical AND operator is applied.</param>
        /// <param name="booleanExpression2">The second boolean expression on which the logical AND operator is applied.</param>
        public GenericBooleanExpressionOr(GenericBooleanExpression<T1, TCollection1, T2, TCollection2> booleanExpression1, GenericBooleanExpression<T1, TCollection1, T2, TCollection2> booleanExpression2)
        {
            this.booleanExpression1 = booleanExpression1;
            this.booleanExpression2 = booleanExpression2;
        }

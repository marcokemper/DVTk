...
//<<===========================================================================
{
    ...
    {
	    sprintf(uid_ptr, "%s.%ld.%d.%d", IMPLEMENTATION_CLASS_UID, timeValue.time, timeValue.millitm, uniq8odd());
    }
    else
    {
	    sprintf(uid_ptr, "%s.%ld.%d.%d", uidRoot_ptr, timeValue.time, timeValue.millitm, uniq8odd());
    }
}

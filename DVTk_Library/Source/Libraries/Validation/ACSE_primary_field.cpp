...
ACSE_PRIMARY_FIELD_CLASS::ACSE_PRIMARY_FIELD_CLASS()
...
bool ACSE_PRIMARY_FIELD_CLASS::checkSyntax()
...
bool ACSE_PRIMARY_FIELD_CLASS::checkRange()
...
bool ACSE_PRIMARY_FIELD_CLASS::checkReference(string refValue)

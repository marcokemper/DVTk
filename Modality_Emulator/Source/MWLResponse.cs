...
namespace ModalityEmulator
{
	...
	{		
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MWLResponse));
			this.listViewMWLRsp = new System.Windows.Forms.ListView();
			this.columnPatName = new System.Windows.Forms.ColumnHeader();
			this.columnPatID = new System.Windows.Forms.ColumnHeader();
			this.columnAccNr = new System.Windows.Forms.ColumnHeader();
			this.columnReqProcID = new System.Windows.Forms.ColumnHeader();
			this.columnSchProcDt = new System.Windows.Forms.ColumnHeader();
			this.columnModality = new System.Windows.Forms.ColumnHeader();
			this.columnSchStnAETitle = new System.Windows.Forms.ColumnHeader();
			this.SuspendLayout();
			// 
			// listViewMWLRsp
			// 

...
namespace Dvtk.Dicom.InformationEntity.QueryRetrieve
{
	...
	/// </summary>
    public class PatientStudyOnlyInformationModel : QueryRetrieveInformationModel, ICommitInformationModel, IRetrieveInformationModel
	{
		/// <summary>
		/// Class Constructor.
		/// </summary>
        ...
        public  override void AddToInformationModel(DvtkData.Media.DicomFile dicomFile, bool storeFile)
        {
            ...
            {
                // Store the dataset as a DCM file if requested.
                if (storeFile == true)
                {

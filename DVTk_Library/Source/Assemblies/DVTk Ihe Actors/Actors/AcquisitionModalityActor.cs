...
namespace Dvtk.IheActors.Actors
{
	...
	/// </summary>
	public class AcquisitionModalityActor : BaseActor, IAcquisitionModalityActor
	{
        ...
        private void SubscribeStorageCommitmentNEventReportResponseEvent()
        {
            ...
            this.OnMessageAvailable += new AcquisitionModalityActor.MessageAvailableHandler(HandleStorageCommitmentNEventReportResponse);
        }

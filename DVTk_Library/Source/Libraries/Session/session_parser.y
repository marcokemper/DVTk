...
%token T_SOCKET_TIMEOUT T_USE_SECURE_SOCKETS T_TLS_VERSION T_CHECK_REMOTE_CERTIFICATE 
...
%token T_DETAILED_RESULTS T_SUMMARY_RESULTS T_INCLUDE_TYPE3_NOTPRESENT T_DUMP_ATTR_REFFILE
...
SessionContent	: T_SESSION_FILE_VERSION INTEGER
	...
	| T_TLS_VERSION STRING
	{
		session_ptr->setTlsVersion($2);
	}

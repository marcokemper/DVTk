'===============================================================================
' Filename:     ADT_OF_IM_WorkflowScript.vbs
'===============================================================================
'
'Description:   AdtPatientRegistration, DSS/OrderFiller, ImageManager - Workflow Script.
'
'===============================================================================
'
' System namespaces
...
Class TestCase
    ...
    Public Sub Execute()
		...
		'		
		Dim actorName As ActorName = New ActorName(ActorTypeEnum.AdtPatientRegistration, "ADT_ID1")		
		Dim adtPatientRegistration As AdtPatientRegistrationActor = CType(IntegrationProfile.GetActor(actorName), AdtPatientRegistrationActor)
		If Not (adtPatientRegistration Is Nothing) Then
	        ...
	        If (IntegrationProfile.Config.CommonConfig.Interactive = True) Then
			    communicationBetweenActorsForm = New CommunicationBetweenActorsForm("[1] Patient Registration", "ADT Patient Registration", adtPatientRegistrationIcon, "DSS/Order Filler", dssOrderFillerIcon)
		...
		'
		actorName = New ActorName(ActorTypeEnum.DssOrderFiller, "OF_ID1")
...
MustInherit Class TestCaseBase
    ...
    Public Sub Initialize(ByVal configurationFilename As String)
		...
		' Initialize the test
		'
		_integrationProfile = New IntegrationProfile("ADT, OF and IM")	

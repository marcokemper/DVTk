...
//*****************************************************************************
//  VALUE_TM_CLASS definition
//*****************************************************************************
class VALUE_TM_CLASS : public BASE_STRING_CLASS  
{
public:
                            VALUE_TM_CLASS();
    virtual                ~VALUE_TM_CLASS();
...
private:
            ...
            DVT_STATUS      IsTime (string date, int start_index, LOG_MESSAGE_CLASS * messages);
            void            ConvertOldTime(string time, string& conv_time);
};

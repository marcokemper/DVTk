...
namespace EvsService
{
    class EvsDetailedResults
    {
        ...
        public void Save(String filename)
        {
            ...
            {
                String message = String.Format("Failed to write DVTK DICOM EVS Detailed Results file: \"{0}\". Error: \"{1}\"", filename, e.Message);
        ...
        {
            writer.WriteStartElement("DetailedResults");

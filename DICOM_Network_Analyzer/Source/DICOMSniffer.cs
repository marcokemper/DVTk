...
namespace SnifferUI
{
	...
	public class DICOMSniffer : System.Windows.Forms.Form
	{
        ...
        string tempCapFile = Application.StartupPath + "\\pdus.tmp";
...
//		}
		...
		private void DICOMSniffer_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			...
			if(CleanUp.Pushed)
			{
				...
				DirectoryInfo theResultDirectoryInfo = new DirectoryInfo(Application.StartupPath + @"\Results\");
				DirectoryInfo theDcmDirectoryInfo = new DirectoryInfo(Application.StartupPath + @"\Dcm\");
		...
		private void menuItem_configsave_Click(object sender, System.EventArgs e)
		{
			...
			saveSetUpFileDlg.InitialDirectory = Application.StartupPath; //CurrentBaseFileName;

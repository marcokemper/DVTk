...
namespace DvtkHighLevelInterface.Dicom.Threads
{
	...
	{		
		...
		internal override void BeforeCallingExecute()
		{
			...
			WriteHtml("<br /><b> DicomThread \"" + Options.Identifier + "\"</b><br />", true, true);
		}
        ...
        public void WriteHtml(String html, bool writeToSummary, bool writeToDetail)
        {
            if (ResultsGatheringStarted)
            {
                ...
                while (index < length)
                {
                    ...
                    this.dvtkScriptSession.WriteHtml(piece, writeToSummary, writeToDetail);
                }
            }
        }
